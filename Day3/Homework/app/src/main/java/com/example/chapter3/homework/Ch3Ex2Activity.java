...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        View squareView = findViewById(R.id.target);
        ObjectAnimator scaleXAnimator = ObjectAnimator.ofFloat(squareView,"scaleX",1f,2f);
        scaleXAnimator.setRepeatCount(ValueAnimator.INFINITE);
        scaleXAnimator.setInterpolator(new LinearInterpolator());
        scaleXAnimator.setDuration(1000);
        scaleXAnimator.setRepeatMode(ValueAnimator.REVERSE);

        ObjectAnimator scaleYAnimator = ObjectAnimator.ofFloat(squareView,"scaleY",1f,2f);
        ...
        View imageView = findViewById(R.id.rainbow);
